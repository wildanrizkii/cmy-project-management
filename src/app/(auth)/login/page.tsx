...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (searchParams.get("expired") === "1") {
      ...
      setError("This Google account is not registered. Please contact your administrator.");
    } else if (err === "OAuthAccountNotLinked") {
      setError("This email is registered with a password. Please sign in with email & password.");
    } else if (err) {
    ...
    <div className="min-h-screen bg-linear-to-br from-[#1e2635] to-[#2d3a4f] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Internal Project Management System</p>
        </div>
